/*
  Goal of this script is to create two oscillators and mix them using the potentiometers as volume control for each.
 */
...
void setup() {
  ...
  sine_0.setFreq(220);      // A3 Sine
  sine_1.setFreq(277.18);   // C#4 Sine
}
