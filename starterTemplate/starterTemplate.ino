...
// Creating a single oscillator that shows hpw many samples are in the wavetable as well as te audio rate
...
void setup() {
  ...
  my_sine.setFreq(220);  // Tells the oscilator to continuosly cycle at 220Hz (A3) until it is told to change to a different frequency
}
...
AudioOutput_t updateAudio() {
  ...
  return StereoOutput::fromNBit(8, (out_sample * meap.volume_val) >> 12, (out_sample * meap.volume_val) >> 12);  // Volume of signal is tied to its bit depth.
}
